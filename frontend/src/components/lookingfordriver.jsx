...
const Lookingfordriver = (props) => {
  return (
    <div>
      ...
      <h3 className='text-2xl font-semibold mb-5 text-black'>Looking for driver</h3>
      <div className='flex gap-2 justify-between flex-col items-center text-gray-800'>
        ...
        <div className='w-full mt-5'>
          ...
          <div className='flex items-center gap-5 p-3'>
            ...
            <div>
                <h3 className='text-lg font-medium'>{props.fare && props.fare[props.vehicleType]} rs</h3>
