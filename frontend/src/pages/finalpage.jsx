  ...
  return (
       <div className="bg-gray-50 min-h-screen flex flex-col p-4">
        ...
        <div className='mt-3'>
          ...
          <p className='text-gray-600 font-bold '> Vechile</p>
          <p className='text-gray-600 '>{new Date(Date.now()).toLocaleString()}
          </p>
          <p className='text-gray-900 font-semibold  '>fare rs</p>
