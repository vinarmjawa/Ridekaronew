...
import ConfirmRidePopUp from '../components/confirmridepanelcap'
      ...
      <div className="flex h-screen w-full max-w-md flex-col overflow-hidden rounded-2xl bg-white shadow-2xl border border-gray-100">
        ...
        <div className="flex flex-col flex-1 justify-between relative p-4">
         ...
         ref={confirmRidePopupPanelRef}
          ...
          >
           <ConfirmRidePopUp  setRidePopupPanel={setRidePopupPanel} setrides={setrides} 
           ride={ride}
            setConfirmRidePopupPanel={setConfirmRidePopupPanel}></ConfirmRidePopUp>
          </div>
        </div>
      </div>
    </div>
